...
/**
 *  Return end point name for the client.
 *  If we set bucket context name we will use 'bucket_name.endpoint' url/
 */
...
Client.prototype.bucketCreate = function(headers, fn) {
  if ('function' == typeof headers) {
    fn = headers;
    headers = {};
  }
...
Client.prototype.bucketDelete = function(headers, fn) {
  if ('function' == typeof headers) {
    fn = headers;
    headers = {};
  }
